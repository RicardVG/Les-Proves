...
public class TrialDAO {
    ...
    public ArrayList<PaperPublication> readjsonTrialPP() throws IOException {
        ...
        Collections.addAll(paperPublicationArrayList,
                googleJson.fromJson(new FileReader(pathPaperPublicationJSON), PaperPublication[].class));
    ...
    public ArrayList<MasterStudies> readjsonTrialMS() throws IOException {
        ...
        Gson googleJson = new Gson();
        Collections.addAll(masterStudiesArrayList,
                googleJson.fromJson(new FileReader(pathMasterStudiesJSON), MasterStudies[].class));
...
/**
     ...
     */    public ArrayList<BudgetRequest> readjsonTrialBR() throws IOException {
        ...
        Collections.addAll(budgetRequestArrayList,
                googleJson.fromJson(new FileReader(pathBudgetRequestJSON), BudgetRequest[].class));
    ...
    public ArrayList<DoctoralThesis> readjsonTrialDT() throws IOException {
        ...
        Gson googleJson = new Gson();
        Collections.addAll(doctoralThesisArrayList,
                googleJson.fromJson(new FileReader(pathDoctoralThesisJSON), DoctoralThesis[].class));
        ...
        try {
            ...
            while (scanner.hasNext()) {
                ...
                if (lineArray.length > 1) {
                    ...
                    paperPublicationArrayList.add(new PaperPublication(lineArray[0], lineArray[1], lineArray[2],
        ...
        try {
            ...
            while (scanner.hasNext()) {
                ...
                if (lineArray.length > 1) {
                    ...
                    masterStudies.add(new MasterStudies(lineArray[0], lineArray[1], Integer.parseInt(lineArray[2]),
